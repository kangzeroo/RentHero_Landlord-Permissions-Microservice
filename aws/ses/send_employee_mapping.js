...
exports.sendEmployeeMappedEmail = function({ email, employee, tenant, building, inquiry, }){
...
function createStaffConfirmationParamsConfig(email, employee, tenant, building, inquiry){
	const params = {
	  ...
	  Message: { /* required */
	    Body: { /* required */
	      Html: {
	        Data: generateStaffInviteHTMLEmail(email, employee, tenant, building, inquiry),
	        Charset: 'UTF-8'
	      },
	      // Text: {
	    ...
	    Subject: { /* required */
	      Data: `Agent ${employee.name} Assigned To Lead for ${building.building_alias}`, /* required */
	      Charset: 'UTF-8'
	    }
	  },
...
function generateStaffInviteHTMLEmail(email, employee, tenant, building, inquiry) {
	return `
		<!DOCTYPE html>
		<html>
		  <head>
		                    ...
		                    <td align='center' valign='top'>
		                        <table border='0' cellpadding='20' cellspacing='0' width='100%' id='emailBody'>
		                            <tr>
                                      ...
                                      <h2>${employee.name} has started communications with ${[tenant.first_name, tenant.last_name].join(' ')}</h2>
                                      ...
                                      <h2>${[tenant.first_name, tenant.last_name].join(' ')} has a group of ${inquiry.group_size}, and they are interested in ${building.building_alias}</h2>
